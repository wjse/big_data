...
public class NLineInputFormatApp {
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        job.setReducerClass(MyKVReducer.class);
    ...
    public static class MyKVMapper extends Mapper<LongWritable, Text , Text , IntWritable>{
    ...
    public static class MyKVReducer extends Reducer<Text , IntWritable , Text , IntWritable>{
        @Override
